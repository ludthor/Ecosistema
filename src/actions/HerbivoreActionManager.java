...
public class HerbivoreActionManager implements ActionManagerI{
	...
	public void draw() {
		...
		float xLeft = self.getX() + ((self.getSize() * (float) Math.random()) * processing.cos(self.getDirection() + processing.radians(90)));
		float yLeft = self.getY() + ((self.getSize() * (float) Math.random()) * processing.sin(self.getDirection() + processing.radians(90)));
		float xBack = self.getX() + ((self.getSize() * (float) Math.random()) * processing.cos(self.getDirection() + processing.radians(180)));
		float yBack = self.getY() + ((self.getSize() * (float) Math.random()) * processing.sin(self.getDirection() + processing.radians(180)));
		float xRight = self.getX() + ((self.getSize() * (float) Math.random()) * processing.cos(self.getDirection() + processing.radians(270)));
		float yRight = self.getY() + ((self.getSize() * (float) Math.random()) * processing.sin(self.getDirection() + processing.radians(270)));
